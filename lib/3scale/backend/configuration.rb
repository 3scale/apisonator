...
module ThreeScale
  module Backend
    ...
    @configuration.tap do |config|
      ...
      config.add_section(:queues, :master_name, :username, :password, :ssl, :ssl_params, :sentinels, :role,
                         :connect_timeout, :read_timeout, :write_timeout, :max_connections)
      config.add_section(:redis, :url, :proxy, :username, :password, :ssl, :ssl_params, :sentinels, :role,
