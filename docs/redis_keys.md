...
This document lists the key-value entries stored in the "storage" _backend_ redis, specifically the "storage" database, which is configured with the `CONFIG_REDIS_PROXY` environment variable.
